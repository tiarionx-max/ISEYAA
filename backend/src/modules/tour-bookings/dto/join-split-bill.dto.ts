 ...
 * Mints a NEW child reference (ISY-TOUR-<12char>) and initiates a separate Flutterwave
...
export class JoinSplitBillDto {
  @ApiProperty({ example: 'tunde@example.com', description: 'Email for this share Flutterwave init' })
  @IsEmail()
  email!: string;
}
