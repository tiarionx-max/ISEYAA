-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CITIZEN', 'TOURIST', 'VENDOR', 'ORGANISER', 'HOST', 'DRIVER', 'CREATIVE', 'LGA_ADMIN', 'STATE_ADMIN', 'SUPER_ADMIN');
...
-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('PENDING', 'ISSUED', 'PAID', 'USED', 'CANCELLED', 'REFUNDED');
...
CREATE TABLE "users" (
    ...
    "nin" TEXT,
    "bvn" TEXT,
    "ndpaConsent" BOOLEAN NOT NULL DEFAULT false,
    "ndpaConsentAt" TIMESTAMP(3),
    "metadata" JSONB,
...
CREATE TABLE "vendors" (
    ...
    "govtLevyPct" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
CREATE TABLE "orders" (
    ...
    "govtLevy" DECIMAL(65,30),
    "vendorPayout" DECIMAL(65,30),
    "paystackRef" TEXT,
...
CREATE TABLE "studio_slots" (
    ...
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "isGovernmentPriority" BOOLEAN NOT NULL DEFAULT false,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "bookings_paystackRef_key" ON "bookings"("paystackRef");
...
-- CreateIndex
CREATE UNIQUE INDEX "studio_bookings_paystackRef_key" ON "studio_bookings"("paystackRef");
