...
- [x] **POOL-02**: A combined-topology load test confirms total open Postgres connections stay under Neon's ceiling with the monolith and `notifications-service` running concurrently
