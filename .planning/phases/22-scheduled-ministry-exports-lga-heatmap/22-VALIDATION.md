...
- [x] Wave 0 covers all MISSING references — web-side RTL tooling (`@testing-library/react` 14.2.1) is already installed and has an existing precedent test (`web/src/components/ui/__tests__/PageTransition.test.tsx`); the one flagged Wave 0 uncertainty is resolved
