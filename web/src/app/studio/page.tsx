      ...
      <div className="p-5 pb-4">
        ...
        <div className="flex items-center gap-4 text-white/40 text-xs">
          <span className="flex items-center gap-1.5">
            <div className="w-5 h-5 rounded-md bg-[rgba(0,0,0,0.35)] flex items-center justify-center">
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full bg-[rgba(0,0,0,0.35)] text-white text-sm rounded-xl px-3.5 py-2.5 border border-white/10 focus:outline-none focus:border-purple-500/50 transition-colors"
              />
            </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 bg-[rgba(0,0,0,0.35)] text-white/60 text-sm font-medium rounded-xl hover:bg-white/10 transition-colors border border-white/8"
              >
                Cancel
              </button>
              <button
