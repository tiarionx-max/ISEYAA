                ...
                <div className="space-y-3 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[rgba(0,0,0,0.35)] text-white text-sm rounded-xl px-3 py-2.5 border border-white/10 focus:outline-none focus:border-indigo-400/50 focus:bg-[rgba(0,0,0,0.45)] transition-all"
                    />
                  </div>
                  <div>
